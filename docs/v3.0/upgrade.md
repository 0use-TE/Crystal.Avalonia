...
Current release: **Crystal.Avalonia 3.1.0**
...
- **`ConfigureOptions` / `CrystalApplication.Options`** → ViewModel-first `DataTemplates` (`EnableViewLocator`) and other framework flags; also DI singleton
